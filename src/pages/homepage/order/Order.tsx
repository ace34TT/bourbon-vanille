...
export const Order = () => {
  return (
    <div id="order">
      <section className="h-80 flex items-center px-72 text-xl bg-primary text-secondary text-center">
      ...
      <section className="py-20 section-2 flex justify-center items-center gap-20">
